...
**Built and live:** dashboard, properties (incl. floor-plan editor and viewer), tenants, leases, bills + SOA, tenant onboarding walk, knowledge base, reports, settings (org-curated property types, charge items, vehicle types, flexible parking rate plans, parking rules, terminals, and parking attendants), Kit event feed, auth.
