...
**Built and live:** dashboard, properties (incl. floor-plan editor and viewer), tenants, leases, bills + SOA, tenant onboarding walk, knowledge base, reports, Parking Overview, settings (org-curated property types, charge items, vehicle types, flexible parking rate plans with duration tiers and optional overnight windows, parking rules, terminals, and parking attendants), Kit event feed, auth.
