...
import { parseOrganizationProfile, toOrganizationProfilePatchBody } from '../utils/organization-profile.util';
...
export class OrganizationProfileService {
  ...
  get(): Observable<OrganizationProfile> {
    return this.http.get(this.base).pipe(map(parseOrganizationProfile));
  }

  save(draft: OrganizationProfileDraft): Observable<OrganizationProfile> {
    return this.http.patch(this.base, toOrganizationProfilePatchBody(draft)).pipe(
