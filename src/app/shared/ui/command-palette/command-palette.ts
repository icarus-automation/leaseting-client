...
const COMMANDS: Command[] = [
  ...
  { id: 'nav-revenue-by-tenant', label: 'Revenue by Tenant', hint: 'Report', icon: 'users', group: 'Go to', keywords: 'sales by customer details billed collected revenue ledger', route: '/reports/revenue-by-tenant' },
  ...
  { id: 'nav-ar-aging-summary', label: 'A/R Aging — Summary', hint: 'Report', icon: 'chart-pie', group: 'Go to', keywords: 'who owes you receivables arrears overdue buckets by tenant', route: '/reports/ar-aging-summary' },
  { id: 'nav-ar-aging-detail', label: 'A/R Aging — Detail', hint: 'Report', icon: 'exclamation-circle', group: 'Go to', keywords: 'who owes you unpaid bills overdue days late worklist', route: '/reports/ar-aging-detail' },
  { id: 'nav-delinquency', label: 'Delinquency & Reminders', hint: 'Report', icon: 'bell', group: 'Go to', keywords: 'late payers chronic sms reminders chase collections', route: '/reports/delinquency' },
